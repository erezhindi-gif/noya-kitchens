        ...
        <div className="max-w-3xl mx-auto px-5 md:px-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8">
            ...
            <a href="tel:0502808180"
              className="group flex flex-col items-center gap-4 p-8 rounded-2xl bg-gradient-to-b from-[#8B6F47] to-[#6b5235] text-white hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <div>
                <p className="font-bold text-lg">050-2808180</p>
                <p className="text-white/70 text-sm">שיחת טלפון</p>
              </div>
            </a>
            ...
            <a href="https://wa.me/972502808180?text=שלום%20ארז%2C%20אני%20מעוניין%20לקבל%20הצעת%20מחיר" target="_blank" rel="noopener noreferrer"
              className="group flex flex-col items-center gap-4 p-8 rounded-2xl bg-gradient-to-b from-[#25D366] to-[#1aab52] text-white hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="w-14 h-14 rounded-full bg-white/15 flex items-center justify-center group-hover:bg-white/25 transition-colors">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">הודעה מיידית</p>
              </div>
            </a>

            {/* Facebook */}
            <a href="https://www.facebook.com/profile.php?id=100054656460007" target="_blank" rel="noopener noreferrer"
              className="group flex flex-col items-center gap-4 p-8 rounded-2xl bg-gradient-to-b from-[#1877F2] to-[#0d5fd4] text-white hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="w-14 h-14 rounded-full bg-white/15 flex items-center justify-center group-hover:bg-white/25 transition-colors">
                <svg width="26" height="26" viewBox="0 0 24 24" fill="white">
              ...
              <div>
                <p className="font-bold text-lg">פייסבוק</p>
                <p className="text-white/70 text-sm">עמוד הפייסבוק שלי</p>
              </div>
            </a>
          </div>
