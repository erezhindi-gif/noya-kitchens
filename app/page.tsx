...
export default async function Home() {
  ...
  const heroCta2     = s?.heroCta2     || "קרא עוד עליי";
  ...
  const footerTagline   = s?.footerTagline   || "NOYA Kitchens by Erez Hindi\nמעל 30 שנות ניסיון בייצור מטבחים ונגרות.";
  const footerCopyright = s?.footerCopyright || "© 2025 NOYA Kitchens by Erez Hindi. כל הזכויות שמורות.";
  const aboutLabel   = s?.aboutLabel   || "הסיפור שלי";
  const aboutTitle   = s?.aboutTitle   || "NOYA Kitchens by Erez Hindi";
  const aboutText1   = s?.aboutText1   || "אני ארז הנדי, נגר מקצועי בעל ניסיון של למעלה מ־30 שנה. את דרכי התחלתי בלימודי נגרות באורט לייבוביץ', ובהמשך ניהלתי מפעל נגרות גדול והתמחיתי בתכנון, עיצוב וייצור מטבחים ברמת גימור גבוהה.";
  const aboutText2   = s?.aboutText2   || "במהלך השנים ליוויתי מאות לקוחות בתכנון וייצור מטבחים, ארונות ופתרונות נגרות מיוחדים, תוך הקפדה על איכות, דיוק ורמת גימור ללא פשרות.";
  const aboutText3   = s?.aboutText3   || "כל מטבח ופרויקט שאני מבצע מלווים באופן אישי ובפיקוח מלא שלי – משלב הפגישה הראשונה, דרך המדידות והתכנון, בחירת החומרים והפרזול, ועד הייצור וההתקנה בבית הלקוח.";
  ...
  const aboutBullet2 = s?.aboutBullet2 || "ליווי אישי משלב המדידות ועד ההתקנה";
  const aboutBullet3 = s?.aboutBullet3 || "ללא קבלני משנה – אני עצמי בכל שלב";
  const aboutBullet4 = s?.aboutBullet4 || "ייצור מקומי ורמת גימור ללא פשרות";
  const contactTitle    = s?.contactTitle    || "רוצים לקבל הצעת מחיר?";
  const contactSubtitle = s?.contactSubtitle || "מוזמנים ליצור איתי קשר בטלפון, בוואטסאפ או במייל לקבלת ייעוץ והצעת מחיר";
